				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="user_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
								...
								<fieldset>
									...
									<input type="text" id="query_account" placeholder="账号" value="${map.account}">
									<button type="submit" onclick="query_User(0)" class="btn btn-sm btn-success">
										查询
...
<th field="account"  onclick="querySort(this,'query_User')">
						账号
					</th>
					<th field="password"  onclick="querySort(this,'query_User')">
						密码
					</th>
					<th field="gxsj" width="170" onclick="querySort(this,'query_User')">
						更新时间
					</th><th field="bz"  onclick="querySort(this,'query_User')">
						备注
					</th>
					<th width="110">
						操作
					...
					<td>
						...
						<td>
							<div class="hidden-sm hidden-xs btn-group">
								<button class="btn btn-xs btn-info" onclick="openEditPage('${map.id}')" title="编辑">编辑</button><button class="btn btn-xs btn-danger" onclick="confirmDeleteDate('${map.id}','${map.account}')" title="删除">删除</button>
							</div>
						</td>
					</tr>
				</c:forEach>
...
<script src="${root}/form/user/js/user_main.js"></script>
</body>
</html>