				...
				<div class="widget-header">
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							<form action="fangjian_index.do" id="queryForm" method="post">
								<!-- 参数隐藏 用于页面传值-->
					...
					<td>
						...
						<td>
							<div class="hidden-sm hidden-xs btn-group">
								<button class="btn btn-xs btn-info" onclick="openEditPage('${map.id}')" title="编辑">编辑</button><button class="btn btn-xs btn-danger" onclick="confirmDeleteDate('${map.id}','${map.number}')" title="删除">删除</button>
							</div>
						</td>
					</tr>
				</c:forEach>
