...
function getUpdateMainJson(id) {
	...
	var update_sum_amout = $("#update_sum_amout").val();
	var jsonObj = {
		"user_id" : update_user_id,
		"code" : update_code,
		"sum_amout" : update_sum_amout,
		"id" : id
	};
